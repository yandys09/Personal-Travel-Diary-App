  ...
  return (
    <div className='relative'>
      <div className="flex items-center justify-end ">
        <div className="">
          <div className="flex items-center gap-3 bg-cyan-50/50 p- rounded-l-lg">
            <button className='btn-small' onClick={onEditClick}><MdOutlineUpdate className='text-lg' />UPDATE STORY</button>
            <button className='btn-small btn-delete' onClick={onDeleteClick}><MdOutlineDelete className='text-lg' />DELETE STORY</button>
            <button className='cursor-pointer' onClick={onClose}><IoMdClose className='text-lg text-slate-400' /></button>
          </div>
        </div>
      </div>
      <div>
